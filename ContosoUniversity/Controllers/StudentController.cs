...
namespace ContosoUniversity.Controllers
{
    public class StudentController : Controller
    {
        ...
        public ActionResult Index(string sortOrder, string searchString)
        {
            ...
            {
                students = students.Where(i => i.LastName.ToUpper().Contains(searchString.ToUpper())
                    || i.FirstMidName.ToUpper().Contains(searchString.ToUpper()));
            }
            switch(sortOrder)
            {
                case "name_desc":
                    students = students.OrderByDescending(i => i.LastName);
                    break;
                case "Date":
                    students = students.OrderBy(i => i.EnrollmentDate);
                    break;
                case "date_desc":
